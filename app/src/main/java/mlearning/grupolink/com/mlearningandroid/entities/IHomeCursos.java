...
public interface IHomeCursos {

    @GET("getCourses")
    Call<HomeCursos> getNewsFrom(@Query("cod_servicio") String CountryCode,
                                 @Query("limit") String limit,
                                 @Query("offset") String offset);

    @DatabaseTable(tableName = "HomeTable")
    public class HomeCursos{
        ...
        public List<rowsHome> getRows() {
            return rows;
        }

        public void setRows(List<rowsHome> rows) {
            this.rows = rows;
        }
