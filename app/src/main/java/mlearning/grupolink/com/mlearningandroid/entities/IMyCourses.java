...
public interface IMyCourses {
    ...
    @GET("getCourses")
    Call<MyCourses> getNewsFrom( @Query("msisdn") String msisdn,
                                 @Query("cod_servicio") String CountryCode,
                                 @Query("limit") String limit,
                                 @Query("offset") String offset);


    @DatabaseTable(tableName = "MyCoursesTable")
    public class MyCourses{
        ...
        public List<rowsMyCourses> getRows() {
            return rows;
        }

        public void setRows(List<rowsMyCourses> rows) {
            this.rows = rows;
        }
