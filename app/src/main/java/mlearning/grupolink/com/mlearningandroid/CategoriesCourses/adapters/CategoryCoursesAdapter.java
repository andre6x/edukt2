package mlearning.grupolink.com.mlearningandroid.CategoriesCourses.adapters;
...
public class CategoryCoursesAdapter extends RecyclerView.Adapter<CategoryCoursesAdapter.ViewHolder> {
    ...
    private List<rowsCategoryCourses> rows;
    private String cdn;
    private ViewHolder.ClickListener clickListener;

    public CategoryCoursesAdapter(Context context , List<rowsCategoryCourses> rows, String cdn , ViewHolder.ClickListener clickListener) {
    ...
    public void updateData(List<rowsCategoryCourses> listRows , String idcdn) {
