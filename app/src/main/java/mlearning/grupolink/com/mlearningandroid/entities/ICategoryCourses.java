...
public interface ICategoryCourses {

    @GET("getCourses")
    Call<CategoryCourses> getNewsFromByCategory(@Query("category") String category,
                                               @Query("cod_servicio") String CountryCode,
                                               @Query("limit") String limit,
                                               @Query("offset") String offset);

    @DatabaseTable(tableName = "CategoryCoursesTable")
    public class CategoryCourses{
        ...
        public List<rowsCategoryCourses> getRows() {
            return rows;
        }

        public void setRows(List<rowsCategoryCourses> rows) {
            this.rows = rows;
        }
