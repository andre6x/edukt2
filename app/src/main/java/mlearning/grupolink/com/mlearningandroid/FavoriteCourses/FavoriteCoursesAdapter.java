...
public class FavoriteCoursesAdapter extends RecyclerView.Adapter<FavoriteCoursesAdapter.ViewHolder> {

    private static final String TAG = "FavoriteCourAdapter";
    ...
    public FavoriteCoursesAdapter(Context context , List<rowsFavoriteCourses> rows, String cdn , ViewHolder.ClickListener clickListener) {
    ...
    public void updateData(List<rowsFavoriteCourses> listRows , String idcdn) {
