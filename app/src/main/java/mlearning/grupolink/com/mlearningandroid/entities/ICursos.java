...
public interface ICursos {
    ...
    @GET("getCourses")
    Call<Cursos> getNewsFrom(@Query("msisdn") String msisdn,
                             @Query("cod_servicio") String CountryCode,
                             @Query("limit") String limit,
                             @Query("offset") String offset);

    @GET("getCourses")
    Call<Cursos> getNewsFrom1(@Query("cod_servicio") String CountryCode,
                              @Query("limit") String limit,
                              @Query("offset") String offset);


    @GET("getCourses")
    Call<Cursos> getNewsFromByCategory(@Query("category") String category,
                                       @Query("cod_servicio") String CountryCode,
                                       @Query("limit") String limit,
                                       @Query("offset") String offset);
    @GET("getCourses")
    Call<Cursos> getNewsFromByCourse(@Query("msisdn") String msisdn,
                                     @Query("cod_servicio") String CountryCode,
    ...
    @GET("getCourses")
    Call<Cursos> getNewsFromCourseData(@Query("cod_servicio") String CodigoServicio,
                                       @Query("course") String course);

    @DatabaseTable(tableName = "CursosTable")
    public class Cursos{
