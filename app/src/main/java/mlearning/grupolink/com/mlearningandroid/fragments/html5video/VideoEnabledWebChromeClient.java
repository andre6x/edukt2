package mlearning.grupolink.com.mlearningandroid.fragments.html5video;
...
public class VideoEnabledWebChromeClient extends WebChromeClient implements MediaPlayer.OnPreparedListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener
{
    ...
    public boolean onBackPressed()
    {
        ...
        if (isVideoFullscreen)
        {   //Log.e("TAG", "**-- videoenablewebchromeclient  isVideoFullscreen true");
            onHideCustomView();
            return true;
        }
        else
        {   //Log.e("TAG", "**-- videoenablewebchromeclient  isVideoFullscreen false");
            return false;
        }
